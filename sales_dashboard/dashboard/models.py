...
class CampaignReport(models.Model):
    ...
    # ML Predictions
    predicted_ctr = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    predicted_conversion_rate = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
...
class MonthlySummary(models.Model):
    ...
    overall_conversion_rate = models.DecimalField(max_digits=5, decimal_places=4, default=0)
    avg_cpc = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    avg_cpm = models.DecimalField(max_digits=10, decimal_places=2, default=0)
...
class MLPrediction(models.Model):
    ...
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='ml_predictions', null=True, blank=True)
    campaign = models.ForeignKey(Campaign, on_delete=models.CASCADE, related_name='ml_predictions', null=True, blank=True)
    ...
    def __str__(self):
        if self.campaign:
            return f"ML Prediction for {self.campaign.name} - {self.prediction_type}"
        elif self.client:
            return f"ML Prediction for {self.client.name} - {self.prediction_type}"
        else:
            return f"ML Prediction - {self.prediction_type}"
...
class FutureForecast(models.Model):
    ...
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='future_forecasts')
    ...
    predicted_spend = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    predicted_ctr = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    predicted_roi = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    ...
    trend_strength = models.DecimalField(max_digits=3, decimal_places=2, default=0.5)
    ...
    def __str__(self):
        return f"{self.client} - {self.forecast_date} - {self.trend_direction}"
...
class ClientPrediction(models.Model):
    ...
    def __str__(self):
        return f"{self.client} - {self.prediction_type} - {self.target_date}"
    
    class Meta:
        ordering = ['-created_at']

class GoogleAdsCredential(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='google_ads_credentials')
...
class LinkedInAdsCredential(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='linkedin_ads_credentials')
...
class MailchimpCredential(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='mailchimp_credentials')
...
class ZohoCredential(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='zoho_credentials')
    access_token = models.CharField(max_length=255)
    refresh_token = models.CharField(max_length=255)
...
class DemandbaseCredential(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='demandbase_credentials')
    api_key = models.CharField(max_length=255)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class GoogleAdsData(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='google_ads_data')
    data = models.JSONField()
    fetched_at = models.DateTimeField(auto_now_add=True)

class MailchimpData(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='mailchimp_data')
    data = models.JSONField()
    fetched_at = models.DateTimeField(auto_now_add=True)

class LinkedInAdsData(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='linkedin_ads_data')
    data = models.JSONField()
    fetched_at = models.DateTimeField(auto_now_add=True)

class ZohoData(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name='zoho_data')
    data = models.JSONField()
    fetched_at = models.DateTimeField(auto_now_add=True)
