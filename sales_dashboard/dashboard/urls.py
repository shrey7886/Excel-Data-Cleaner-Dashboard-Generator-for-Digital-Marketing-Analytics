...
urlpatterns = [
    ...
    path(
        'client-reports/',
        auth_views.client_reports_view,
        name='client_reports'
    ),
    ...
    path(
        'generate-prediction/<int:data_id>/',
        views.generate_prediction,
        name='generate_prediction'
    ),
    path(
        'client-prediction/<int:prediction_id>/',
        views.prediction_detail,
        name='prediction_detail'
    ),
    path(
        'download-excel/<int:data_id>/',
        views.download_excel_dashboard,
        name='download_excel_dashboard'
    ),

    # ML Predictions and Forecasts
    path('ml-predictions/', views.ml_predictions_view, name='ml_predictions'),
    path(
        'campaign-prediction/<int:prediction_id>/',
        views.campaign_prediction_detail,
        name='campaign_prediction_detail'
    ),
    path(
        'api/generate-prediction/',
        views.generate_ml_prediction,
        name='generate_ml_prediction'
    ),
    ...
    path(
        'monthly-summary/<int:summary_id>/',
        views.monthly_summary_detail,
    ...
    path(
        'connect/google-ads/',
        views.connect_google_ads,
        name='connect_google_ads'
    ),
    path(
        'connect/linkedin-ads/',
        views.connect_linkedin_ads,
    ...
    path(
        'connect/tools/',
        views.connect_tools_portal,
        name='connect_tools_portal'
    ),
    ...
    path(
        'oauth/linkedin/initiate/',
        views.linkedin_oauth_initiate,
        name='linkedin_oauth_initiate'
    ),
    path(
    ...
    path(
        'api/connect/google-ads/',
        views.connect_google_ads_ajax,
        name='connect_google_ads_ajax'
    ),
    path(
        'api/connect/linkedin-ads/',
        views.connect_linkedin_ads_ajax,
        name='connect_linkedin_ads_ajax'
    ),
    path(
        'api/connect/mailchimp/',
        views.connect_mailchimp_ajax,
        name='connect_mailchimp_ajax'
    ),
    path(
        'api/connect/zoho/',
        views.connect_zoho_ajax,
        name='connect_zoho_ajax'
    ),
    path(
        'api/connect/demandbase/',
        views.connect_demandbase_ajax,
        name='connect_demandbase_ajax'
    ),
    path(
        'api/disconnect/',
        views.disconnect_platform_ajax,
        name='disconnect_platform_ajax'
    ),
    path(
        'api/connection-status/',
        views.get_connection_status,
    ...
    path(
        'monthly-predictions/<int:summary_id>/',
        views.monthly_predictions_view,
        name='monthly_predictions'
    ),
    path(
        'download-monthly-predictions/<int:summary_id>/',
        views.download_monthly_predictions,
        name='download_monthly_predictions'
    ),

    # Analytics views
    path(
        'analytics/google_ads/',
        views.google_ads_analysis,
        name='google_ads_analysis'
    ),
    path(
        'analytics/linkedin_ads/',
        views.linkedin_ads_analysis,
        name='linkedin_ads_analysis'
    ),
    ...
    path(
        ...
        views.demandbase_analysis,
        name='demandbase_analysis'
    ),
    path('analytics/unified/', views.unified_analytics, name='unified_analytics'),
    path(
        'analytics/unified/download/',
        views.download_unified_analytics,
        name='download_unified_analytics'
    ),
    ...
    path(
        'advanced-analytics/',
        views.advanced_analytics_view,
        name='advanced_analytics'
    ),
    # Advanced Analytics API
    path(
        'api/advanced-analytics/',
        views.advanced_analytics_api,
        name='advanced_analytics_api'
    ),
