...
GOOGLE_OAUTH_REDIRECT_URI = os.environ.get('GOOGLE_OAUTH_REDIRECT_URI', 'http://localhost:8000/dashboard/oauth/google/callback/')
...
LINKEDIN_OAUTH_REDIRECT_URI = os.environ.get('LINKEDIN_OAUTH_REDIRECT_URI', 'http://localhost:8000/dashboard/oauth/linkedin/callback/') 